...
@SourceType(value = "BingARP", label = "Bing",uiConfig = "bing-layout.json")
public class BingConf extends AbstractArpConf<BingConf> {
  private static final String ARP_FILENAME = "arp/implementation/bing-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.bing.BingDriver";
